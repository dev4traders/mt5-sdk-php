...
use D4T\MT5Sdk\Exceptions\FailedActionException;
use D4T\MT5Sdk\Exceptions\InvalidDataException;
...
class MT5SdkTest extends TestCase
{
    ...
    {
        $manager = new Manager($_ENV['MT5_API_TOKEN'], $_ENV['MT5_API_ENDPOINT'], $http = Mockery::mock(Client::class));
